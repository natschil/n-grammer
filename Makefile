...
CPP = g++
CC = gcc
FLAGS = -Wall -g -Wextra -fopenmp -D NDEBUG -march=native  -I/usr/include -ldl -lm -lunistring
CFLAGS = -Wall -g -Wextra -fopenmp -D NDEBUG -march=native  -I/usr/include -ldl -lm -lunistring
