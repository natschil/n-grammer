...
all: ngram.analysis
OBJECTS=main.o invert_index.o manage_metadata.o search.o get_top.o make_wordlength_stats.o view_wordlength_stats.o searchable_file.o entropy_of.o entropy_index.o entropy_index_get_top.o util.o entropy_index_stats.cpp
